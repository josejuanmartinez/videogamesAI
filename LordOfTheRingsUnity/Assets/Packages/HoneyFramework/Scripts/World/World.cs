...
namespace HoneyFramework
{
    ...
    public class World : MonoBehaviour
    {
        ...
        public Camera foregroundBakingCamera;
        ...
        private void Awake()
        {
            ...
            if (foregroundBakingCamera == null) Debug.LogError("Missing terrain camera! It may be child of World object, please drag & drop it here!");
