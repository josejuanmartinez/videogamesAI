...
namespace Pathfinding {
	...
	public class AstarPathEditor : Editor {
		...
		public override void OnInspectorGUI () {
            ...
            UnityEngine.EventType storedEventType = Event.current.type;
		...
		void DrawGraphHeader (GraphEditor graphEditor) {
			...
			if (graph.name == "" && Event.current.type == UnityEngine.EventType.Repaint && GUI.GetNameOfFocusedControl() != graphGUIDString) {
		...
		public void OnSceneGUI () {
            ...
            UnityEngine.EventType et = Event.current.type;
		...
		public static void EditTags () {
			...
			if (astar == null) astar = GameObject.FindFirstObjectByType<AstarPath>();
		...
		public void SaveGraphsAndUndo (UnityEngine.EventType et = UnityEngine.EventType.Used, string eventCommand = "") {
			...
			if ((Undo.GetCurrentGroup() != lastUndoGroup || et == UnityEngine.EventType.MouseUp) && eventCommand != "UndoRedoPerformed") {
