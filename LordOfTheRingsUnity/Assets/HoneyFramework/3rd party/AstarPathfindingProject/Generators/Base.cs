...
namespace Pathfinding {
	...
	public abstract class NavGraph {
		...
		/** Temporary fix for the HoneyHex framework. If the A* Pathfinding Project is upgraded to a version > 4.0.10 this will be fixed */
		public IEnumerable<Progress> ScanInternalExposed () {
			return ScanInternal();
		}
